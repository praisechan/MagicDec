...
python tests/dynamic_verify_test/run_3step_profile.py --model_name qwen2.5-32b --gamma1 4 --gamma2 28 --budget1 0.02 --budget2 0.25 --prefix_len 65568 --dataset pg19

python tests/dynamic_verify_test/run_2step_profile.py --model_name qwen2.5-32b --gamma1 4 --gamma2 32 --budget1 0.10 --prefix_len 65568 --dataset pg19
python tests/dynamic_verify_test/run_2step_profile.py --model_name qwen2.5-32b --gamma1 4 --gamma2 32 --budget1 0.40 --prefix_len 65568 --dataset pg19
