...
--csv_path num_replica_4_prefix_len_16416_hot_cluster_ratio_0.08_planes_per_die_32_model_name_qwen2.5-14b_dataset_pg19_optimal \
--num_channels 1 \
--chips_per_channel 1 \
--dies_per_chip 1 \
