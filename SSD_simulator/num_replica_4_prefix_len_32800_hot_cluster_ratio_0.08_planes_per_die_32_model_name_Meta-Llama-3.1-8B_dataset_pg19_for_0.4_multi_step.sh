...
--csv_path num_replica_4_prefix_len_32800_hot_cluster_ratio_0.08_planes_per_die_32_model_name_Meta-Llama-3.1-8B_dataset_pg19_for_0.4 \
--num_channels 1 \
--chips_per_channel 1 \
--dies_per_chip 1 \
...
--window_size 64 \
--layer_num 32 \
--profiling_dir /home/juchanlee/MagicDec/profile/data_2step_for_0.4/ \
--num_replica 4 \
